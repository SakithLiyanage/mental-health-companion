...
const Journal = () => {
  ...
  useEffect(() => {
    const loadEntries = async () => {
      try {
        ...
        // Test the API first
        try {
          const testResponse = await fetch('https://mental-health-companion-backend-eight.vercel.app//api/journal/test', {
            headers: {
        ...
        const response = await fetch('https://mental-health-companion-backend-eight.vercel.app//api/journal', {
          headers: {
            'Authorization': `Bearer ${token}`,
            'Content-Type': 'application/json'
          }
  ...
  const handleSaveEntry = async () => {
    ...
    try {
      ...
      alert('Failed to save journal entry. Check if backend server is running on https://mental-health-companion-backend-eight.vercel.app/');
  ...
  const handleDeleteEntry = async (entryId) => {
    try {
      ...
      const response = await fetch(`https://mental-health-companion-backend-eight.vercel.app//api/journal/${entryId}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
