...
const GoalAnalytics = () => {
  ...
  const fetchAnalytics = useCallback(async () => {
    try {
      ...
      const response = await fetch(`https://mental-health-companion-backend-eight.vercel.app//api/goals/analytics?timeRange=${timeRange}`, {
        headers: {
  ...
  useEffect(() => {
    fetchAnalytics();
    fetchGoals();
  }, [timeRange, dailyGoal, lastRefresh, fetchAnalytics, fetchGoals]); // Add fetchGoals as dependency
